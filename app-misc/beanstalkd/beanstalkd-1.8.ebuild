...
# $Header: /var/cvsroot/gentoo-x86/app-misc/beanstalkd/beanstalkd-1.8.ebuild,v 1.2 2012/10/07 04:14:16 mr_bones_ Exp $
...
src_install() {
	...
	newconfd "${FILESDIR}/conf-1.4.2-vc" beanstalkd
	newinitd "${FILESDIR}/init-1.7-vc" beanstalkd
}
